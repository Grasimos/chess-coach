// Inline SVG chess pieces - clean, professional, no external dependencies
// Inspired by the classic Merida/Alpha style

interface PieceProps {
    size: number;
}

function WhiteKing({ size }: PieceProps) {
    return (
...
function WhiteQueen({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
...
function WhiteRook({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="#fff" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
                <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5" strokeLinecap="round" />
                <path d="M34 14l-3 3H14l-3-3" />
                <path d="M15 17v12.5h15V17" strokeLinecap="round" strokeLinejoin="miter" />
                <path d="M12 32.5l3-2.5h15l3 2.5" strokeLinecap="round" />
            </g>
        </svg>
    );
}

function WhiteBishop({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
...
function WhiteKnight({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
                ...
                <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#000" strokeWidth="0" />
            </g>
        </svg>
    );
}

function WhitePawn({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
function BlackKing({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
...
function BlackQueen({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
                ...
                <path d="M12.5 31.5h20M11.5 34.5a35 35 1 0 0 22 0" fill="none" stroke="#fff" />
            </g>
        </svg>
    );
}

function BlackRook({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="#000" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
                <path d="M9 39h27v-3H9v3z" strokeLinecap="round" />
                <path d="M12.5 32l1.5-2.5h17l1.5 2.5" strokeLinecap="round" />
                <path d="M12 36v-4h21v4H12z" strokeLinecap="round" />
                <path d="M14 29.5v-13h17v13H14z" strokeLinecap="round" strokeLinejoin="miter" />
                <path d="M14 16.5L11 14h23l-3 2.5H14z" strokeLinecap="round" />
                <path d="M11 14V9h4v2h5V9h5v2h5V9h4v5H11z" strokeLinecap="round" />
...
function BlackBishop({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
...
function BlackKnight({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" stroke="#000" strokeWidth="1.5" strokeLinejoin="round">
                ...
                <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill="#fff" stroke="#fff" strokeWidth="0" />
...
function BlackPawn({ size }: PieceProps) {
    return (
        <svg width={size} height={size} viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
...
// Map FEN characters to piece components
...
export function renderPiece(piece: string, size: number): React.ReactNode {
